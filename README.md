...
**2.  Activate the operating system**                                                                                       
 ...
 > This step is should be automatic once you connect the VM to the Internet. 
 
  1.  Open the Hyper-V Manager on the host. 
...
<table>
<tr>
    <th align="Center" style="width:35%">Tasks</th><th style="width:65%">Detailed steps</th>
</tr>
<tr >
<td><b>1. Create a Snapshot</b><br />
    <pre>Note that having many snapshots can 
adversely affect performance. You can delete snapshots 
you no longer need and Hyper-V will merge these
when the VM is not running.</pre>
    </td>
    <td><ol type="a">
        <li>Prepare the VM(s) in the state you wish to capture.</li>
        <li>Open or return to the Hyper-V Manager</li>
        <li>Select the VM and click Snapshot under Actions.</li>
        <li>Wait for the snapshot captures to complete.</li>
        <li>(optional) Right-click a snapshot to rename it.</li>
        </ol>
    </td>
 </tr>
 <tr>
